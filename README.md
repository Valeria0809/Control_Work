...
![All text](Task3.png)
![All text](Task3.1.png)
4. Установить и удалить deb-пакет с помощью dpkg.
![All text](Task4.png)
![All text](Task4.1.png)
![All text](Task4.2.png)
...
![All text](Task8.png)
![All text](Task9.png)
[История команд](/Task8.sql)
9. Заполнить низкоуровневые таблицы именами(животных), командами которые они выполняют и датами рождения.
![All text](Task9.1.png)
![All text](Task9.2.png)
[История команд](/Task_9.sql)
...
![All text](Task11.png)
![All text](Task11.1.png)
12. Объединить все таблицы в одну, при этом сохраняя поля, указывающие на прошлую принадлежность к старым таблицам.
![All text](Task12.png)
![All text](Task12.1.png)
